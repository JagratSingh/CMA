...
export class EditBooksComponent {
  ...
  onSubmit() {
    const available = this.editFormGroup.value.available === 'true' ? true : false;
    const existingBook = this.BookService.getBookById(this.book!.id);
    ...
    if (existingBook) {
        this.BookService.updateBook({
            ...
            available: available,
            checkoutBook: existingBook.checkoutBook,
        });
    }
